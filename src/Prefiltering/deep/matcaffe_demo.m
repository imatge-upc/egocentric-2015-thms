function [scores, layers] = matcaffe_demo(im, use_gpu, caffemodel, prototxt)
...
if caffe('is_initialized') == 0
  ...
  model_def_file = prototxt; %'/imatge/alidon/work/PFM/src/Prefiltering/deep/train_val_finetunning_test.prototxt';
  model_file = caffemodel; %'/imatge/alidon/work/PFM/src/Prefiltering/deep/informativeDetectCNN_finetunning_Petia2_iter_2800.caffemodel';
  use_gpu=1;
